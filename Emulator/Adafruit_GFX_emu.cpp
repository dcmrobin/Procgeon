...
// Minimal 3x5 pixel ASCII font (printable 32-126)
// Each character is 3 bytes (columns), 5 bits used per byte (rows, LSB at top)
const uint8_t Adafruit_GFX::profont10_font[] = {
#define PF3X5(ch0,ch1,ch2) ch0,ch1,ch2
    // Space (32)
    PF3X5(0x00,0x00,0x00), // ' '
    PF3X5(0x00,0x17,0x00), // '!'
    PF3X5(0x03,0x00,0x03), // '"'
    PF3X5(0x1F,0x0A,0x1F), // '#'
    PF3X5(0x0A,0x1F,0x05), // '$'
    PF3X5(0x19,0x04,0x13), // '%'
    PF3X5(0x0A,0x15,0x1A), // '&'
    PF3X5(0x00,0x03,0x00), // '''
    PF3X5(0x0E,0x11,0x00), // '('
    PF3X5(0x00,0x11,0x0E), // ')'
    PF3X5(0x05,0x02,0x05), // '*'
    PF3X5(0x04,0x0E,0x04), // '+' 
    PF3X5(0x10,0x08,0x00), // ','
    PF3X5(0x04,0x04,0x04), // '-'
    PF3X5(0x00,0x10,0x00), // '.'
    PF3X5(0x18,0x04,0x03), // '/'
    PF3X5(0x1F,0x11,0x1F), // '0'
    PF3X5(0x00,0x1F,0x00), // '1'
    PF3X5(0x1D,0x15,0x17), // '2'
    PF3X5(0x15,0x15,0x1F), // '3'
    PF3X5(0x07,0x04,0x1F), // '4'
    PF3X5(0x17,0x15,0x1D), // '5'
    PF3X5(0x1F,0x15,0x1D), // '6'
    PF3X5(0x01,0x01,0x1F), // '7'
    PF3X5(0x1F,0x15,0x1F), // '8'
    PF3X5(0x17,0x15,0x1F), // '9'
    PF3X5(0x00,0x0A,0x00), // ':'
    PF3X5(0x10,0x0A,0x00), // ';'
    PF3X5(0x04,0x0A,0x11), // '<'
    PF3X5(0x0A,0x0A,0x0A), // '='
    PF3X5(0x11,0x0A,0x04), // '>'
    PF3X5(0x01,0x15,0x07), // '?'
    PF3X5(0x0E,0x15,0x16), // '@'
    PF3X5(0x1F,0x05,0x1F), // 'A'
    PF3X5(0x1F,0x15,0x0A), // 'B'
    PF3X5(0x0E,0x11,0x11), // 'C'
    PF3X5(0x1F,0x11,0x0E), // 'D'
    PF3X5(0x1F,0x15,0x15), // 'E'
    PF3X5(0x1F,0x05,0x05), // 'F'
    PF3X5(0x0E,0x15,0x1D), // 'G'
    PF3X5(0x1F,0x04,0x1F), // 'H'
    PF3X5(0x11,0x1F,0x11), // 'I'
    PF3X5(0x08,0x10,0x0F), // 'J'
    PF3X5(0x1F,0x04,0x1B), // 'K'
    PF3X5(0x1F,0x10,0x10), // 'L'
    PF3X5(0x1F,0x06,0x1F), // 'M'
    PF3X5(0x1F,0x0E,0x1F), // 'N'
    PF3X5(0x0E,0x11,0x0E), // 'O'
    PF3X5(0x1F,0x05,0x07), // 'P'
    PF3X5(0x0E,0x19,0x1E), // 'Q'
    PF3X5(0x1F,0x0D,0x1A), // 'R'
    PF3X5(0x12,0x15,0x09), // 'S'
    PF3X5(0x01,0x1F,0x01), // 'T'
    PF3X5(0x0F,0x10,0x1F), // 'U'
    PF3X5(0x07,0x18,0x07), // 'V'
    PF3X5(0x1F,0x0C,0x1F), // 'W'
    PF3X5(0x1B,0x04,0x1B), // 'X'
    PF3X5(0x03,0x1C,0x03), // 'Y'
    PF3X5(0x19,0x15,0x13), // 'Z'
    PF3X5(0x1F,0x11,0x00), // '['
    PF3X5(0x03,0x04,0x18), // '\\'
    PF3X5(0x00,0x11,0x1F), // ']'
    PF3X5(0x02,0x01,0x02), // '^
    PF3X5(0x10,0x10,0x10), // '_'
    PF3X5(0x01,0x02,0x00), // '`'
    PF3X5(0x1C,0x14,0x1C), // 'a'
    PF3X5(0x1F,0x14,0x08), // 'b'
    PF3X5(0x1C,0x14,0x14), // 'c'
    PF3X5(0x08,0x14,0x1F), // 'd'
    PF3X5(0x1C,0x1C,0x14), // 'e'
    PF3X5(0x04,0x1E,0x05), // 'f'
    PF3X5(0x18,0x14,0x1C), // 'g'
    PF3X5(0x1F,0x04,0x18), // 'h'
    PF3X5(0x00,0x1D,0x00), // 'i'
    PF3X5(0x10,0x10,0x0D), // 'j'
    PF3X5(0x1F,0x0C,0x12), // 'k'
    PF3X5(0x11,0x1F,0x10), // 'l'
    PF3X5(0x1C,0x0C,0x1C), // 'm'
    PF3X5(0x1C,0x04,0x18), // 'n'
    PF3X5(0x1C,0x14,0x1C), // 'o'
    PF3X5(0x1C,0x0A,0x04), // 'p'
    PF3X5(0x04,0x0A,0x1C), // 'q'
    PF3X5(0x1C,0x06,0x04), // 'r'
    PF3X5(0x14,0x1C,0x0A), // 's'
    PF3X5(0x04,0x1F,0x14), // 't'
    PF3X5(0x1C,0x10,0x1C), // 'u'
    PF3X5(0x0C,0x10,0x0C), // 'v'
    PF3X5(0x1C,0x18,0x1C), // 'w'
    PF3X5(0x14,0x08,0x14), // 'x'
    PF3X5(0x0C,0x10,0x1C), // 'y'
    PF3X5(0x14,0x1C,0x14), // 'z'
    PF3X5(0x04,0x1B,0x11), // '{'
    PF3X5(0x00,0x1F,0x00), // '|'
    PF3X5(0x11,0x1B,0x04), // '}'
    PF3X5(0x02,0x07,0x02), // '->'
    PF3X5(0x08,0x1C,0x08)  // '<-'
#undef PF3X5
};
