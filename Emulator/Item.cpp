...
GameItem itemList[] = {
  ...
  { Bread,     FoodCategory,"Bread",     0,30,0,0,0,"Stale but edible.",                          "Bread",     "You eat the bread. Not great, but filling.",       2},
  { Cheese,    FoodCategory,"Cheese",    0,15,0,0,0,"Smells suspicious. Tastes fine.",             "Cheese",    "You nibble the cheese. A little goes a long way.", 2},
  { StaleMeat, FoodCategory,"Stale Meat",-5,40,0,0,0,"Probably fine. Probably.",                  "Stale Meat","You eat the meat. Your stomach protests.",         2,true,StaleMeatEffect},
  { Berries,   FoodCategory,"Berries",   0,10,0,0,0,"Small but sweet. Hard to find underground.", "Berries",   "You eat the berries. Delicious, if scarce.",       4},
